...
#include "sha512_cpp.h" // Functions Declarations
...
void sha512::Sha512_init( Sha512_Context* __sha512_context ) {
...
void sha512::Sha512_free( Sha512_Context* __sha512_context ) { free( __sha512_context->data_padded ); }

// Set the hash value
// Execute all needed proccesses for the sha512 hash generation
// Proccess: Set given values / Padding / Algorithm
void sha512::Sha512_hash( Sha512_Context* __sha512_context, void* __message, uint64_t __message_size ) {
...
void sha512::Sha512_padding( Sha512_Context* __sha512_context ) {
    ...
    __sha512_context->data_padded = malloc( __sha512_context->data_padded_bits_length / 8 );
...
void sha512::Sha512_algorithm( Sha512_Context* __sha512_context ) {
...
void sha512::Sha512_algorithm_single_block( Sha512_Context* __sha512_context, void* __block_message ) {
...
void sha512::Sha512_digest( Sha512_Context* __sha512_context, void* __data ) {   
...
uint64_t sha512::Sha512_rotate_right( uint64_t x, int n ) { return (x >> n) | (x << (64 - n)); }

// Logical function Ch
uint64_t sha512::Sha512_ch( uint64_t a, uint64_t b, uint64_t c ) { return (a & b) ^ (~a & c); }

// Logical function Maj
uint64_t sha512::Sha512_maj( uint64_t a, uint64_t b, uint64_t c ) { return (a & b) ^ (a & c) ^ (b & c); }

// Logical function SIGMA 0
uint64_t sha512::Sha512_SIGMA_0( uint64_t x ) { return Sha512_rotate_right( x, 28 ) ^ Sha512_rotate_right( x, 34 ) ^ Sha512_rotate_right( x, 39 ); }

// Logical function SIGMA 1
uint64_t sha512::Sha512_SIGMA_1( uint64_t x ) { return Sha512_rotate_right( x, 14 ) ^ Sha512_rotate_right( x, 18 ) ^ Sha512_rotate_right( x, 41 ); }

// Logical function sigma 0
uint64_t sha512::Sha512_sigma_0( uint64_t x ) { return Sha512_rotate_right( x, 1 ) ^ Sha512_rotate_right( x, 8 ) ^ (x >> 7); }

// Logical function sigma 1
uint64_t sha512::Sha512_sigma_1( uint64_t x ) { return Sha512_rotate_right( x, 19 ) ^ Sha512_rotate_right( x, 61 ) ^ (x >> 6); }


// Reverse the order of bytes in a uint64
uint64_t sha512::reverse_uint64( uint64_t __num ) {
